...
//        aE.getScene().setRoot(root);
        ...
        try {
                myNewScene =  FXMLLoader.load(getClass().getResource("../Views/ajoutEvenement.fxml"));
    ...
    private void addInvite(ActionEvent event) throws IOException {
       ...
       //  FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/ajoutInvite.fxml"));
        ...
        try {
                myNewScene =  FXMLLoader.load(getClass().getResource("../Views/ajoutInvite.fxml"));
    ...
    private void user(ActionEvent event)  throws IOException  {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/listeEventUser.fxml"));
         Parent root = loader.load();
