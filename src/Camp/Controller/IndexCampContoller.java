...
"                            ds.SupprimerDocument(data.getId());a: " + selectedCamp);
    ...
    private void CreatePdf(ActionEvent event) throws Exception {
       ...
       PdfWriter.getInstance(document,new FileOutputStream("C:\\Users\\amin\\Documents\\NetBeansProjects\\PiDev\\RefugiePDF.pdf"));
       document.open();
       ...
       ResultSet rs=st.executeQuery("SELECT nomCamp, adresseCamp, nbrefugier,nomuser FROM `camp`");
       while(rs.next()){
